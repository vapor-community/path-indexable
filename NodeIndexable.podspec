Pod::Spec.new do |spec|
  spec.name         = 'NodeIndexable'
  spec.version      = '0.0.0'
  spec.license      = 'MIT'
  spec.homepage     = 'https://github.com/qutheory/node-indexable'
  ...
  spec.source       = { :git => 'https://github.com/qutheory/node-indexable.git', :tag => "#{spec.version}" }
  ...
  spec.subspec "Default" do |ds|
    ds.source_files = 'Sources/NodeIndexable/**/*.{swift}'
  end
